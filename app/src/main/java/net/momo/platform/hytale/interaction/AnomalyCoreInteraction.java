...
/** Hytale SimpleInteraction wrapper for Anomaly Core. */
public class AnomalyCoreInteraction extends SimpleInteraction {

    public static final BuilderCodec<AnomalyCoreInteraction> CODEC =
        BuilderCodec.builder(AnomalyCoreInteraction.class, AnomalyCoreInteraction::new).build();

    private static final UUID HANDLER_ID = UUID.fromString("00000000-0000-0000-0001-000000000002");
