...
/** Hytale SimpleInteraction wrapper for Sigil of Absorption. */
public class SigilAbsorptionInteraction extends SimpleInteraction {

    public static final BuilderCodec<SigilAbsorptionInteraction> CODEC =
        BuilderCodec.builder(SigilAbsorptionInteraction.class, SigilAbsorptionInteraction::new).build();

    private static final UUID HANDLER_ID = UUID.fromString("00000000-0000-0000-0001-000000000003");
