...
/** Hytale SimpleInteraction wrapper for Sigil of Manifestation. */
public class SigilManifestationInteraction extends SimpleInteraction {

    public static final BuilderCodec<SigilManifestationInteraction> CODEC =
        BuilderCodec.builder(SigilManifestationInteraction.class, SigilManifestationInteraction::new).build();

    private static final UUID HANDLER_ID = UUID.fromString("00000000-0000-0000-0001-000000000004");
